    ...
    <head>
        ...
        <style>
            ...
            @media (max-width: 991.98px) {
                ...
                /* --- CARTÕES SUPER COMPACTOS (MOBILE) --- */
                ...
                /* 7. AÇÕES (Canto Superior Direito - Absoluto) */
            ...
            @media (min-width: 992px) {
                ...
                /* Esconder o badge de loading quando está inativo e no desktop */
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                tabelaViagens.on('xhr.dt', function () { 
                    $('.loading-badge').hide(); 
                    // Reativa os tooltips após o carregamento
            ...
            // CORRIGIDO: Esta função usa a API do DataTables para ordenar
            ...
            function editTravel(id, dataHora, condutor, recolha, entrega, paxADT, paxCHD, flightNumber, clientName, clientNumber, serviceType) {
                ...
                document.getElementById('editclientNumber').value = clientNumber; // Campo Número do Cliente
