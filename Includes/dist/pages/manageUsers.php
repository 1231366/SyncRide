                ...
                <form action="createUser.php" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="inputPassword" name="password" required readonly />
                        </div>
                        <button type="button" class="btn btn-outline-primary mt-2" id="generatePasswordBtn">Gerar Password Segura</button>
                        <button type="button" class="btn btn-outline-success mt-2" id="copyPasswordBtn" style="display: none;">Copiar</button>
                    </div>
...
// Evento para gerar a password
document.getElementById("generatePasswordBtn").addEventListener("click", function() {
    const password = generatePassword();
    document.getElementById("inputPassword").value = password;
    document.getElementById("copyPasswordBtn").style.display = "inline-block"; // Exibir o botão de copiar
});
