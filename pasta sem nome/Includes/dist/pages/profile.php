            ...
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                <img
                  ...
                  alt="User Image"
                />
                <span class="d-none d-md-inline">Tiago Silva</span>
              </a>
            ...
            >
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="addRide.php" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Criar Viagem</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="ManageRides.html" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Gerir Viagens</p>
                    </a>
                  </li>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="manageUsers.html" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center"> <span class="d-none d-md-inline"><?php  echo $_SESSION['name']; ?></span></h3>

                <p class="text-muted text-center"> <?php echo $_SESSION['role'] == 1 ? 'Admin' : 'Driver'; 
            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link active" href="#activity" data-toggle="tab">Definições</a></li>
                </ul>
              </div>
